...
class AmnioticForm(FlaskForm):
    ...
    wife_birthday_year = fields.StringField()#db.Column(db.Integer, nullable=False)
    wife_birthday_month = fields.StringField()#db.Column(db.Integer, nullable=False)
    ...
    referral_hospital = QuerySelectField(query_factory=query_factory_user, get_pk=get_pk)#db.Column(db.String(60))
    screen_date = fields.StringField(widget=widgets.DatePickerWidget())#db.Column(db.Date)   # 筛查日期
    ...
    operation_pregnancy_week = fields.StringField()#db.Column(db.Integer)  # 手术孕周
    operation_pregnancy_day = fields.StringField()#db.Column(db.Integer)  # 手术孕天
    ...
    blood_pressure_systolic = fields.StringField()#db.Column(db.Integer)  #血压_收缩压
    blood_pressure_diastolic = fields.StringField()#db.Column(db.Integer)  #血压_舒张压
    ...
    chromosome_reporting_date = fields.StringField()#db.Column(db.Date)  # 染色体报告日期
    ...
    poverty_gene_reporting_date = fields.StringField()#db.Column(db.Date)  # 地贫基因报告日期
    ...
    exception_notification_date = fields.StringField()#db.Column(db.Date)  # 异常通知日期
    ...
    delivery_pregnancy_week = fields.StringField()#db.Column(db.Integer)  # 分娩孕周
    ...
    result_printing_times = fields.StringField()#db.Column(db.Integer)  #结果打印次数
    e3_nmol_1 = fields.StringField()#db.Column(db.Float)  # E3_nmol/l
    e3_mo = fields.StringField()#db.Column(db.Float)  #E3_Mo
    early_pregnancy_b_hcg_ng_l = fields.StringField()#db.Column(db.Float)  # 早孕β-HCG_ng/l
    early_pregnancy_b_hcg_mo = fields.StringField()#db.Column(db.Float)  # 早孕β-HCG_Mo
